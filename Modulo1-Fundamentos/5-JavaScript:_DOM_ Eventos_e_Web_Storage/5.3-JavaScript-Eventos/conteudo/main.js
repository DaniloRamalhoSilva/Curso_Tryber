...
// 1.2. Note que uma das caixas está um pouco acima das outras. Por que isso ocorre? R: tem a class "tech"
...
firstLi.addEventListener('click', function(){
    ...
    input.placeholder = 'Altere a primeira tecnologia';
    input.value = '';
} );
...
myWebpage.addEventListener('dblclick',function() {
    var win = window.open('https://daniloramalhosilva.github.io/', '_blank');
    win.focus();
});
